...
schedule.addEvent("AI Seminar",120,room_group_list.room_group_list[0])
...
schedule.addEvent("Robotics Seminar",120,room_group_list.room_group_list[1])
...
schedule.addEvent("AI Workshop",120,room_group_list.room_group_list[2])
...
schedule.addEvent("Networks Seminar",180,room_group_list.room_group_list[0])
schedule.event_list[9]["datetime"]=datetime(2020,6,20,12,0)
...
schedule.addEvent("Internship Presentation",120,room_group_list.room_group_list[0])
